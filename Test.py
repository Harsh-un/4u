...
TEAMAWE = render('{JOY SIRR}', colors=['white', 'red'], align='center')
print(f'''
\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                      {TEAMAWE}
\033[2;36m INSTAGRAM FREE TOOL V1 | Channel -> @te4mawe IG~ @joysirr
\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
''')
...
𝑟𝑒𝑠𝑒𝑡 : [ {rest(username)} ]
⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊⚊
[ TG~ @joysirr channel~ @te4mawe  ]
"""
    with open('joysirrhits.txt', 'a') as f:
        f.write(info_text + "\n")
    try:
...
# Note :- tool bilkul free hai edit kar ke sell karne walon ki maa ki chut

# Note: The tool is absolutely free, fuck the mother of those who edit and sell it 
